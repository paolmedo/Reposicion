package com.reposicion.inventario.excepciones;
...
public class GlobalException {
    ...
    public ResponseEntity<RespuestaError> manejoPeticionIncorrecta(MethodArgumentNotValidException excep) {
        String mensajeCorto = excep.getBindingResult().getAllErrors().get(0).getDefaultMessage();
        RespuestaError error = new RespuestaError(mensajeCorto, 400, LocalDateTime.now());
